...
class CafeForm(FlaskForm):
    ...
    location=StringField('Cafe Location on Google Maps.(URL)',validators=[DataRequired(),URL(message="Enter valid URL")])
    opening = StringField('Opening Time eg.8AM', validators=[DataRequired()])
    closing = StringField('Opening Time eg.5:30PM', validators=[DataRequired()])
